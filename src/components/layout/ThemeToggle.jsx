...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="w-[80px] h-[36px] rounded-full bg-slate-200/50 dark:bg-zinc-800/50 animate-pulse shrink-0" />
    );
  }
  ...
  return (
    <label className="inline-flex items-center relative cursor-pointer select-none shrink-0">
      <input
      ...
      <svg
        ...
        className="fill-white peer-checked:opacity-60 absolute w-[18px] h-[18px] left-[9px] pointer-events-none duration-300"
      >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-[18px] h-[18px] right-[9px] pointer-events-none duration-300"
      >
